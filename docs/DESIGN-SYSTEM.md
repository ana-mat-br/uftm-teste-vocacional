...
### Estrutura do bixinho (composição)

Cada bixinho final = corpo-base + paleta + antena + acessório
...
- **Largura máx:** 480px
- **Contém:** todos os elementos (header, bixinho, resultado, alternativos, mensagem, botões)
...
- **Layout horizontal-friendly** — bixinho à esquerda, info à direita
