...
export const CURSOS: Curso[] = [
  ...
  { nome: "Engenharia Elétrica", papelMissao: "Engenheira de Sistemas Vitais", vetor: [0, 2, 3, 0, 0, 0, 2], campus: "Uberaba" },
  { nome: "Engenharia Química", papelMissao: "Engenheira de Processos", vetor: [0, 3, 3, 0, 0, 1, 0], campus: "Uberaba" },
  ...
  { nome: "Banco de Dados", papelMissao: "Arquiveira de Bordo", vetor: [0, 0, 0, 2, 0, 0, 3], campus: "Uberaba" },
  { nome: "Inteligência Artificial", papelMissao: "Operadora-IA da Missão", vetor: [0, 3, 2, 0, 1, 0, 3], campus: "Uberaba" },
  ...
  { nome: "Educação Física", papelMissao: "Treinadora da Tripulação", vetor: [2, 1, 2, 1, 2, 1, 0], campus: "Uberaba" },
  { nome: "Licenciatura em Educação do Campo", papelMissao: "Engenheira Agrária Comunitária", vetor: [2, 1, 1, 2, 3, 3, 0], campus: "Uberaba" },

  // === Cultivo / Natureza ===
  { nome: "Agronomia", papelMissao: "Cultivadora de Vida Planetária", vetor: [1, 3, 3, 1, 1, 3, 0], campus: "Uberaba/Iturama" },
  { nome: "Zootecnia", papelMissao: "Criadora de Vida Animal", vetor: [3, 3, 2, 1, 0, 3, 0], campus: "Iturama" },
];
