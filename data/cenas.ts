...
export const CENAS: Cena[] = [
  {
    ...
    opcoes: [
      { emoji: "🤔", texto: "Anoto tudo, levanto a mão pra perguntar das margens de erro do Protocolo", pontos: [0, 2, 0, 0, 0, 0, 1] },
  ...
  },
  {
    ...
    opcoes: [
      ...
      { emoji: "🍞", texto: "Tento oferecer algo — gesto de paz interespécie", pontos: [2, 0, 0, 2, 0, 0, 0] },
      { emoji: "🧪", texto: "Coleto amostras (sem machucar) pra entender a biologia delas", pontos: [0, 2, 0, 0, 0, 2, 0] },
      { emoji: "📡", texto: "Mando imagens pra Terra na hora — humanidade inteira precisa ver isso", pontos: [0, 0, 0, 3, 0, 0, 0] },
      { emoji: "🛡️", texto: "Recuo a equipe e estabeleço protocolo de não-contato preventivo", pontos: [1, 0, 0, 0, 2, 0, 0] },
    ],
  },
  {
    id: 10,
